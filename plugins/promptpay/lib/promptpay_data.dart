...
class PromptPayData {
  late PromptPayField emvcoVersion;
  late PromptPayField qrType;
  late PromptPayField transferring;
  late PromptPayField transferringSubType;
  late PromptPayField transferringPhoneNumber;
  late PromptPayField transferringIdentityNumber;
  late PromptPayField transferringEWallet;
  late PromptPayField billing;
  late PromptPayField billingType;
  late PromptPayField billingID;
  late PromptPayField billingReferenceNumber1;
  late PromptPayField billingReferenceNumber2;
  late PromptPayField country;
  late PromptPayField currency;
  late PromptPayField amount;
  late PromptPayField unknownFieldTypeForBilling;
  late PromptPayField checksum;
  ...
  PromptPayData.fromQRData(String qrData) {
    ...
    while (currentIndex < qrData.length) {
      ...
      var promptPayField =
          PromptPayField.fromSubStringOfQRData(qrData.substring(currentIndex, currentIndex + 2 + 2 + dataLength));
    ...
    if (transferring != null) {
      ...
      while (trasferringCurrentIndex < transferring.data.length) {
        var dataLength =
            int.parse(transferring.data.substring(trasferringCurrentIndex + 2, trasferringCurrentIndex + 4));
